...
This folder holds the deeper documentation that would otherwise overload the root README.
...
- `packages/`: current package docs (Angular + .NET) and planned package briefs
- `demo/`: how to run and validate the demo application locally, including cross-stack API routes
- `.ai/`: repo-specific workflow for AI-assisted implementation, review, release work, and detailed backlog planning
