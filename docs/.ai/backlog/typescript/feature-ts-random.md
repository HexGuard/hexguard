...
Random ID generation and sampling utilities for TypeScript â€” UUID v4/v7, nanoid, random string, random integer, seeded RNG, array shuffle, and weighted random selection. Every app needs random IDs, and `crypto.randomUUID()` isn't available in all environments.
...
1. Provide `uuid()` â€” RFC 9562 UUID v4 (and v7 time-ordered).
2. Provide `nanoid(size?)` â€” short URL-safe random string.
3. Provide `randomInt(min, max)`, `randomString(length, alphabet?)`.
4. Provide `shuffle(array)` â€” Fisher-Yates shuffle.
5. Provide `sample(array, n?)` â€” random sample with/without replacement.
6. Provide `weightedRandom(items, weights)` â€” weighted random selection.
...
```typescript
// â”€â”€ IDs â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Random Values â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

export function randomInt(min: number, max: number): number;  // min inclusive, max exclusive
export function randomFloat(min?: number, max?: number): number;  // Default 0â€“1
...
// â”€â”€ Seeded (Deterministic) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
