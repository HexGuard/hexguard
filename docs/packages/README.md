...
| `@hexguard/angular-feature-flags`       | Released    | Feature flag evaluation for Angular â€” typed flag checks across routes, templates, and service logic with sync support for .NET backends.                                                                                                    | [Deep Dive](angular-feature-flags.md), [npm-facing README](../../angular/packages/angular-feature-flags/README.md), [Demo runbook](../demo/README.md)              |
| `HexGuard.ProblemDetails`               | Released    | RFC 9457 Problem Details for HTTP APIs â€” types, builders, and ASP.NET Core integration for producing standard error responses.                                                                                                              | [Deep Dive](hexguard-problem-details.md), [npm-facing README](../../dotnet/src/HexGuard.ProblemDetails/README.md), [Demo runbook](../demo/README.md)               |
...
The full catalog of **357 proposed packages** across 5 stacks is maintained in `docs/.ai/backlog/`:

| Stack       | Briefs  | Folder                          | Naming Convention                                     |
| ----------- | ------- | ------------------------------- | ----------------------------------------------------- |
| Angular     | 149     | `docs/.ai/backlog/angular/`     | `@hexguard/angular-{name}`                            |
| Blazor      | 79      | `docs/.ai/backlog/blazor/`      | `HexGuard.Blazor.{Name}`                              |
...
| TypeScript  | 44      | `docs/.ai/backlog/typescript/`  | `@hexguard/ts-{name}`                                 |
| **Total**   | **406** |                                 |                                                       |

An additional **195 extension proposals** across 22 existing packages are tracked in `docs/.ai/backlog/package-extensions.md`.
