...
The full catalog of **333 proposed packages** across 5 stacks is maintained in `docs/.ai/backlog/`:

| Stack       | Briefs  | Folder                          | Naming Convention                                     |
| ----------- | ------- | ------------------------------- | ----------------------------------------------------- |
| Angular     | 128     | `docs/.ai/backlog/angular/`     | `@hexguard/angular-{name}`                            |
| Blazor      | 47      | `docs/.ai/backlog/blazor/`      | `HexGuard.Blazor.{Name}`                              |
| .NET        | 84      | `docs/.ai/backlog/dotnet/`      | `HexGuard.{Name}`                                     |
| Cross-stack | 41      | `docs/.ai/backlog/cross-stack/` | Paired `HexGuard.{Name}` + `@hexguard/angular-{name}` |
| TypeScript  | 33      | `docs/.ai/backlog/typescript/`  | `@hexguard/ts-{name}`                                 |
| **Total**   | **333** |                                 |                                                       |

An additional **136 extension proposals** across 22 existing packages are tracked in `docs/.ai/backlog/package-extensions.md`.
