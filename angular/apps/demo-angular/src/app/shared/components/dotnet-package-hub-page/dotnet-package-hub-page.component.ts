...
@Component({
        ...
        @if (entry().angularCounterpartLabel; as counterpart) {
          <p class="dotnet-pkg-hub__counterpart">
            ...
            @if (entry().angularCounterpartId; as route) {
              <a class="demo-link-chip" [routerLink]="'/packages/' + route">
                Open Angular hub
              </a>
            }
          </p>
      ...
      <section class="dotnet-pkg-hub__demos" aria-label="Package demos">
        <div class="dotnet-pkg-hub__demos-heading">
          <div>
            ...
            <h3>{{ entry().demoCount }} demo{{ entry().demoCount !== 1 ? 's' : '' }} for this package</h3>
          </div>
  ...
  styles: [`
    :host { display: block; }
    .dotnet-pkg-hub { display: grid; gap: 1.6rem; }
    ...
    .dotnet-pkg-hub__header { align-items: start; }
    ...
    .dotnet-pkg-hub__header-meta {
      display: flex; gap: 0.8rem; align-items: start; flex-wrap: wrap; min-width: 0;
    }
    .dotnet-pkg-hub__counterpart {
      display: flex; gap: 0.6rem; align-items: center; flex-wrap: wrap; margin: 0;
    }
    .dotnet-pkg-hub__counterpart-pill {
      background: rgba(217,119,75,0.1); border-color: rgba(217,119,75,0.3); color: #a35832;
    }
    .dotnet-pkg-hub__demos { display: grid; gap: 1rem; }
    ...
    .dotnet-pkg-hub__overview-links { width: 100%; }
    .dotnet-pkg-hub__overview-links > * { flex: 1 1 12rem; justify-content: center; }
    @media (max-width: 900px) {
      .dotnet-pkg-hub__overview-links > * { flex-basis: 14rem; }
    }
    @media (max-width: 720px) {
      .dotnet-pkg-hub__overview-links > * { flex-basis: 100%; }
    }
  `],
