...
@Component({
  standalone: true,
  selector: 'demo-dotnet-capabilities-hub-page',
  imports: [DotnetPackageHubPageComponent, RouterLink],
  template: `
    <demo-dotnet-package-hub-page
      [entry]="packageEntry"
      overviewTestId="dotnet-pkg-hexguard-capabilities"
...
export class DotnetCapabilitiesHubPageComponent {
  readonly packageEntry = getDotnetSitePackage('hexguard-capabilities');
  readonly ecosystem = SITE_ECOSYSTEMS.find((e) => e.id === 'capabilities')!;
}
