...
import { ANGULAR_ASYNC_STATE_PACKAGE } from '../../../demo-registry';
...
@Component({
  ...
  imports: [RouterLink],
  template: `
    <section class="package-overview" data-testid="package-angular-async-state">
      ...
      <section class="package-overview__grid" aria-label="Package demos">
        @for (demo of packageEntry.demos; track demo.route) {
          <a
            ...
            [attr.data-testid]="'package-async-state-demo-' + demo.id"
          >
            ...
            <span class="package-overview__meta"
              >Headless lifecycle contract, outlet rendering, and generated source panel</span
            >
          </a>
        }
      </section>
...
export class AngularAsyncStateHomePageComponent {
  readonly packageEntry = ANGULAR_ASYNC_STATE_PACKAGE;
}
