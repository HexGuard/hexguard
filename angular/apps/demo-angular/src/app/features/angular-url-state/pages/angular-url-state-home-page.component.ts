...
import { ANGULAR_URL_STATE_PACKAGE } from '../../../demo-registry';
...
@Component({
  ...
  imports: [RouterLink],
  template: `
    <section class="package-overview" data-testid="package-angular-url-state">
      ...
      <section class="package-overview__grid" aria-label="Package demos">
        @for (demo of packageEntry.demos; track demo.route) {
          <a
            ...
            [attr.data-testid]="'package-demo-' + demo.id"
          >
            ...
            <span class="package-overview__meta"
              >Live URL state, generated source panel, and docs links</span
            >
          </a>
        }
      </section>
...
export class AngularUrlStateHomePageComponent {
  readonly packageEntry = ANGULAR_URL_STATE_PACKAGE;
}
