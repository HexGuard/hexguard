  ...
  template: `
    <demo-stack-hub-layout testId="cross-stack-hub-page">
      <div heroContent>
        ...
        <p class="demo-card__summary stack-hub__lede">
        ...
        <div class="demo-link-row">
          <a class="stack-hub__action" routerLink="/angular">Explore Angular packages</a>
          <a class="stack-hub__action" routerLink="/dotnet">Explore .NET packages</a>
        </div>
      </div>

      <div sections>
        <!-- Cross-stack pairs -->
        <section class="stack-hub__section" aria-labelledby="pairs-heading">
        ...
        @if (sharedApiConsumers.length > 0) {
          <section class="stack-hub__section" aria-labelledby="consumers-heading">
            <div class="demo-card demo-card--stack stack-hub__consumers-card">
