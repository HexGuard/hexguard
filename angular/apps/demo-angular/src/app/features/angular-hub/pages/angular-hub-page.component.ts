...
@Component({
    ...
    <demo-stack-hub-layout testId="angular-hub-page">
      <div heroContent>
        ...
        <div class="demo-link-row">
          <a
            class="angular-hub__action"
            routerLink="/dotnet"
          >Explore .NET packages</a>
          <a
            class="angular-hub__action"
            routerLink="/cross-stack"
          >View cross-stack pairs</a>
        </div>
      </div>
  ...
  styles: [`
    :host { display: block; }
    .angular-hub__lede { max-width: 52rem; }
    .angular-hub__action {
      display: inline-flex;
      align-items: center;
    ...
    .stack-hub__expand-toggle {
      ...
      justify-self: start; min-height: 2.6rem; padding: 0.6rem 1rem;
    ...
    @media (max-width: 720px) {
      .stack-hub__expand-toggle { width: 100%; justify-self: stretch; }
    }
  `],
