...
export const DEMO_SOURCE_SNIPPETS: Record<string, DemoSourceSnippet> = {
  ...
  'angular-query-form/orders-demo-state': {
    ...
    description:
      'Generated from the real Orders Query Form demo component source.',
    language: 'ts',
    sourcePath:
