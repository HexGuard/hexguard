---
description: 'Use when editing the demo Angular app in apps/demo-angular/src. Covers docs-grade examples, stable Playwright selectors, and URL-state demonstration requirements.'
applyTo: 'apps/demo-angular/src/**'
---
...
- When routes or interactive flows change, update `playwright/tests/demo-angular.spec.ts` and `docs/demo/README.md`.
